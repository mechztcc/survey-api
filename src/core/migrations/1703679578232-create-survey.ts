...
export class CreateSurvey1703679578232 implements MigrationInterface {
    name = 'CreateSurvey1703679578232'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."survey_status_enum" AS ENUM('closed', 'opened')`);
        await queryRunner.query(`CREATE TABLE "survey" ("id" SERIAL NOT NULL, "question" character varying NOT NULL, "expires_at" TIMESTAMP, "status" "public"."survey_status_enum" NOT NULL DEFAULT 'opened', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, CONSTRAINT "PK_f0da32b9181e9c02ecf0be11ed3" PRIMARY KEY ("id"))`);
